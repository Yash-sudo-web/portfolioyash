...
export const Footer = () => {
  return (
    ...
    <div className='h-28 custom:h-40 flex max-custom:flex-col text-white justify-between items-center'>
        ...
        <div></div>    
        <div className='max-small:text-[18px] max-very-small:text-[14px] max-smaller:gap-8 max-very-small:gap-12 max-very-small:font-bold max-custom:pb-4 flex text-[22px] text-white gap-16 custom:pr-[5%] max-custom:px-[5%]'>
